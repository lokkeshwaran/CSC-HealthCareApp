...
public class list_appoinments extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_appoinments);
        ...
        if (isNetworkAvailable()) {
            ...
            myWebView.loadUrl("http://lokkeshwaran.cu.ma/csccoin/listappoinments.php?pid="+pid);

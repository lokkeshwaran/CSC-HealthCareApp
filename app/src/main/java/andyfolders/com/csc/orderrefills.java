...
public class orderrefills extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderrefills);
        ...
        if (isNetworkAvailable()) {
            ...
            myWebView.loadUrl("http://lokkeshwaran.cu.ma/csccoin/yourrefills.php?pid="+pid);
